...
export const SpinnerLoadingIndicator = ({
  ...
  return (
    <div className="relative">
      <StatusBorder className="border-primary">{children}</StatusBorder>

      <div className="absolute inset-0 z-50 rounded-[9px] bg-background/50 backdrop-blur-xs" />
      <div className="absolute inset-0 z-50">
        <span className="absolute top-[calc(50%-1.25rem)] left-[calc(50%-1.25rem)] inline-block h-10 w-10 animate-ping rounded-full bg-primary" />
